    ...
    <div class="header__content">
        <div class="container">
            <div class="header__content-left">
                ...
                Logo
                ======================================-->
                <a class="ps-logo" href="/"><img src="img/template/logo_light.png" alt=""></a>
                <!--=====================================
                Menú
                ======================================-->
                        ...
                        <ul class="menu--dropdown">
                            <?php foreach ($menuCategories as $key => $value) : ?>
                                <li class="menu-item-has-children has-mega-menu">
                                    <a href="<?php echo $path . $value->url_category; ?>" class="justify-content-center"><i class="<?php echo $value->icon_category; ?>"></i><?php echo $value->name_category; ?></a>
                                    <div class="mega-menu">
            ...
            <div class="header__content-right">
                <div class="header__actions">
                    ...
                    <div class="ps-cart--mini">
                        <a class="header__extra" class="btn"><i class="icon-bag2"></i><span><i class="totalWishBag"><?php echo $totalSC; ?></i></span></a>
                            ...
                            <div class="ps-cart__items" id="bagTok">
                                <?php if ($totalSC > 0) : ?>
                                    ...
                                    if(is_integer($value["quantity"]) && $value["quantity"] > 0 && is_string($value["product"]) && is_string($value["details"])):
                                        ...
                                        $select = "url_worker,country_worker,city_worker,url_subcategory,name_subcategory,displayname_user,id_user,picture_user,price_worker,username_user";
                                        $url = CurlController::api() . "relations?rel=workers,users,subcategories&type=worker,user,subcategory&linkTo=url_worker&equalTo=" . $value["product"] . "&select=" . $select;
                                        $method = "GET";
                                        $fields = array();
                                        $header = array();
                                    ...
                                    ?>
                                        <div class="ps-product--cart-mobile">
                                            <div class="ps-product__thumbnail mb-0">
                                                <a class="m-0" href="<?php echo $path . $result->url_worker; ?>">
                                                    <img class="rounded-circle" src="img/users/<?php echo $result->id_user; ?>-<?php echo $result->username_user; ?>/<?php echo $result->picture_user; ?>" alt="<?php echo $result->displayname_user; ?>">
                                                </a>
                                            </div>
                                            <div class="ps-product__content m-0">
                                                <a class="ps-product__remove text-danger btn" onclick="removeBagSC('<?php echo $result->url_worker; ?>','<?php echo TemplateController::path().$_SERVER['REQUEST_URI']; ?>')">
                                                    <i class="fas fa-trash-alt"></i>
                                                </a>
                                                <a class="m-0 font-weight-bold" href="<?php echo $path . $result->url_worker; ?>"><?php echo $result->displayname_user; ?></a> <br>
                                                <!-- <p class="m-0"><strong></strong> BEDAJU</p> -->
                                                <small class="font-italic"><?php echo $result->name_subcategory; ?></small> <br>
                                                ...
                                                ?>
                                                <!-- </span></p> -->
                                                <small class="font-weight-light"><?php echo $result->country_worker." | ".$result->city_worker; ?></small>
                                                <small> 
                                                    <!-- <strong>Cantidad: </strong> <span class="<?php //echo $value["product"]; ?>"><?php //echo $value["quantity"]; ?></span>  -->
                                                <strong>Precio:</strong> $
                                                    <?php //if ($result->offer_product != null) : ?>
                                                        <?php
                                                            ...
                                                            $preceProduct = $result->price_worker;
                                                            echo $preceProduct; ?>
                                                    <?php //else : ?>
                                                        <?php 
                    ...
                    ======================================-->
                    <div class="ps-block--user-header">
                        <div class="ps-block__left"><a href="<?php echo $path ?>acount&login"><i class="icon-user"></i></a></div>
                        <div class="ps-block__right">
